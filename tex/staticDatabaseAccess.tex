...
\index{Database Configuration Field Types}Each database field has a type as defined in the next chapter. For static database access a new and simpler set of field 
