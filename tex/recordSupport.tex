...
\index{init\_record - example}\begin{verbatim}
...
\index{process - example}\begin{verbatim}
...
\index{Global Record Support Routines}A number of global record support routines are available. These routines are intended for use by the record specific 
