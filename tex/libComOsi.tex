...
\index{devDisconnectInterruptVME}
...
\index{devEnableInterruptLevelVME}
...
\index{devDisableInterruptLevel}
This routine has been deprecated, and currently only exists for backwards compatibility purposes.
