...
\end{verbatim}\index{dbGetField}This routine locks, calls \verb|dbGet|, and unlocks.
...
\begin{verbatim}long dbGet(
    ...
    long *nRequest, /* ptr to number of elements */
    void *pfl);     /* used by monitor routines */
\end{verbatim}\index{dbGet}This routine retrieves the data referenced by \verb|paddr| and converts it to the format specified by \verb|dbrType|. 
