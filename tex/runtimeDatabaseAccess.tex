...
A server layer should instanciate one of these and pass a pointer to it to dbRegisterServer:
...
The functions provided by the server lay are used as follows.
