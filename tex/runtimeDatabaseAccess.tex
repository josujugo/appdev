...
\index{dbCaPutLinkCallback}\textless{}base\textgreater{}/src/std/dev/\index{devAoSoftCallback.c}devAoSoftCallback.c provides an example of how to use this function. It contains:
